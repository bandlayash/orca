...
#elif defined(__EMSCRIPTEN__) or defined(__linux__) or defined(__APPLE__) or defined(__FreeBSD__) or defined(__NetBSD__) or   \
...
#include <sys/types.h>
#if defined(ANDROID) || defined(__HAIKU__) || defined(__EMSCRIPTEN__)
#include <fcntl.h>
#else
#include <sys/fcntl.h>
#endif
