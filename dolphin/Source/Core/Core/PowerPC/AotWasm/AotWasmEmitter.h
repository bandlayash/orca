...
public:
  AotWasmEmitter() = default;
  explicit AotWasmEmitter(u8* begin, u8* end) : m_code(begin), m_code_end(end) {}
...
class AotWasmCodeBlock : public Common::CodeBlock<AotWasmEmitter, false>
{
private:
