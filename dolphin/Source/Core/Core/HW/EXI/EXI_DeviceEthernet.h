...
private:
  ...
  protected:
#if defined(WIN32) || defined(__EMSCRIPTEN__) || defined(__linux__) || defined(__APPLE__) || defined(__FreeBSD__) ||          \
    defined(__OpenBSD__)
...
#elif defined(__EMSCRIPTEN__) || defined(__linux__) || defined(__APPLE__) || defined(__FreeBSD__) || defined(__OpenBSD__)
    int fd = -1;
#endif
  };
