...
std::unique_ptr<StreamBuffer> StreamBuffer::Create(u32 type, u32 size)
{
  ...
  // WebGL 2 does not support buffer storage, persistent mapping, or reliable sync fences from
  // worker threads. BufferSubData is the only fully supported streaming method.
